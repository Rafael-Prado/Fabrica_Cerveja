...
public class CervejasImpl implements CervejasQueries {
	...
	public Page<Cerveja> filtra(CervejaFilter filtro, Pageable pageable) {
		...
		int totalDeRegistroPagina = pageable.getPageSize();
		int primeiroRegistro = paginaAtual * totalDeRegistroPagina;
		
		criteria.setFirstResult(primeiroRegistro);
		criteria.setMaxResults(totalDeRegistroPagina);
		
		adiconarFiltro(filtro, criteria);
	...
	private void adiconarFiltro(CervejaFilter filtro, Criteria criteria) {
		if(filtro != null){
